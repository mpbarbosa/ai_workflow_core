...
cd .workflow_core
git fetch --tags
git log v1.0.0..v1.1.0  # Review commits between versions

# Check for suspicious changes
git diff v1.0.0..v1.1.0  # Review code changes
...
# Output format:
# abc123... .workflow_core (v1.0.0)  # ✅ Clean
# +abc123... .workflow_core (v1.0.0) # ⚠️  Modified
# -abc123... .workflow_core (v1.0.0) # ⚠️  Not initialized

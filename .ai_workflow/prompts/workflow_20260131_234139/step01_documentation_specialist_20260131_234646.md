...
**Changes Detected**:
**Change Summary**: 26 files changed across multiple directories
**Affected directories**: .,.github,config,docs,docs/guides,examples,examples/shell,scripts,workflow-templates,workflow-templates/workflows,

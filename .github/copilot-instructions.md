...
│   ├── ai_prompts_project_kinds.yaml   # Project-specific AI prompts (v1.2.3, aligned with project_kinds)
...
**Supported Project Kinds** (defined in config/project_kinds.yaml v1.2.3):
...
13. **docs/api/CONFIG_REFERENCE.md**: Complete `.workflow-config.yaml` field reference (835 lines, v1.2.3 - updated 2026-02-10)
14. **docs/api/PLACEHOLDER_REFERENCE.md**: Placeholder patterns and substitution guide (756 lines)
15. **docs/api/PROJECT_KINDS_SCHEMA.md**: Project kinds schema v1.2.3 reference (777 lines)
...
- **project_kinds.yaml schema version**: 1.2.3 (last updated: 2026-01-30)

...
- **[PROJECT_KINDS_SCHEMA.md](docs/api/PROJECT_KINDS_SCHEMA.md)** - Project kinds schema v1.2.4 reference
...
- **[AI_PROMPTS_REFERENCE.md](docs/api/AI_PROMPTS_REFERENCE.md)** *(v1.2.4)* - Central role definitions, `role_ref:` pattern, TypeScript loader API
...
### TypeScript Config Loader *(v1.2.4)*
...
**Parent Project Status**: v1.2.4 (Phase 3 Complete - File Operations & Utilities)

...
# 4. Review changes
git log --oneline $(git describe --tags --abbrev=0)..v1.2.6
...
# 7. Commit update
git add .workflow_core
git commit -m "chore: Update ai_workflow_core to v1.2.6"
```
...
./scripts/update-workflow-core.sh v1.2.6
```
...
# Example: Rolling back from v1.2.6 to v1.0.2
git checkout v1.0.2

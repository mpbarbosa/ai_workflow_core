...
- [Migration Paths](#migration-paths)
  ...
  - [Upgrading to v1.0.2](#upgrading-to-v100-current)
...
**Example**:
- `v1.0.2` → `v1.1.0`: Safe upgrade, no breaking changes
...
| Minor (1.0.2 → 1.1.0) | 🟡 Medium | 15 min | Config validation |
...
|-----------------|---------------------------|------------------------------------------|---------|--------|------|
| v1.0.2 | v4.0.0+ | v1.3.0+ | 18+ | 3.8+ | 4.0+ |
...
```bash
git commit -m "chore: upgrade ai_workflow_core to v1.0.2"
```
...
cd .workflow_core
git checkout v1.0.2  # Your previous version
cd ..
git add .workflow_core

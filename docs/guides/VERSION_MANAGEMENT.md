...
- **MINOR** (v1.2.4): New features, backward-compatible
...
git fetch --tags
git tag -l
# Output: v1.0.2, v1.0.2, v1.2.4, etc.
```
...
cd ..
git add .workflow_core
git commit -m "Update ai_workflow_core from v1.0.2 to v1.2.4"
...
- Recommended: v1.2.4 or later for enhanced features
```
...
strategy:
  matrix:
    workflow_core_version: ['v1.0.2', 'v1.2.4', 'main']
```
...
| v2.0.0       | v1.2.4          | ✅ Supported | Recommended |

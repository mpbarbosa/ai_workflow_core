...
| [PROJECT_KINDS_SCHEMA.md](docs/api/PROJECT_KINDS_SCHEMA.md) | Project kinds schema (8 types) | 777 | 1.2.1 |
| [AI_HELPERS_REFERENCE.md](docs/api/AI_HELPERS_REFERENCE.md) | AI personas & token efficiency | 1,177 | 1.0.2 |
| [AI_PROMPTS_REFERENCE.md](docs/api/AI_PROMPTS_REFERENCE.md) | Project-specific AI prompts | 1,197 | 1.2.1 |

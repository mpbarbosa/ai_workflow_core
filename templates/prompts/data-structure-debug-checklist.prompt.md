---
agent: 'agent'
description: 'Systematic checklist for debugging data structure mismatches between components'
---

${input:symptom:Describe the bug or symptom you are debugging}
